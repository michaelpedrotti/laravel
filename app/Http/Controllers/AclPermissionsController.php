...
use App\Http\Requests\AclPermissionsFormRequest as FormRequest;
use App\Models\AclPermissions as Model; 
...
class AclPermissionsController extends Controller {
    ...
    public function index(Request $request) {
        ...
        if ($request->isXmlHttpRequest()) {
            return Datatables::eloquent($model->search())
				...
				//	return $query->id;
				//})
				//->editColumn('acl_id', function ($query) {
				//	return $query->acl_id;
				//})
				//->editColumn('permission_id', function ($query) {
    ...
    public function form(Request $request) {
        ...
        //$this->authorize(($request->route('id') ? 'ACLPERMISSIONS_EDITAR' : 'ACLPERMISSIONS_CADASTRAR'), 'PermissaoPolicy');
        
        $model = Model::findOrNew($request->route('id'));
        //$model->authorize();
        $model->fill($request->all());
		
		$view = view('acl-permissions.form', [
            'model' => $model
        ]);
        ...
        if($request->isMethod('post')) {
            ...
            try {
                ...
                $this->setMessage('Permissão do Perfil foi salva com sucesso!', 'success'); 
            }
    ...
    public function show(Request $request) {
        ...
        //$this->authorize('ACLPERMISSIONS_VISUALIZAR', 'PermissaoPolicy');
    ...
    public function remove(Request $request) {
        ...
        //$this->authorize('ACLPERMISSIONS_EXCLUIR', 'PermissaoPolicy');
