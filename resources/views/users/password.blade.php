...
<div class="tab-pane active">
	...
	<div class="form-body">
		<div class="form-group {{ $errors->has('password_current') ? 'has-error' : '' }}">
			...
			<div class="col-md-9">
				{{ Form::password('password_current', ['class' => 'form-control senha_antiga', 'placeholder' => 'Senha Antiga']) }}
		...
		<div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
			...
			<div class="col-md-9">
				{{ Form::password('password', ['class' => 'form-control nova_senha', 'placeholder' => 'Nova Senha']) }}
		...
		<div class="form-group {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
			...
			<div class="col-md-9">
				{{ Form::password('password_confirmation', ['class' => 'form-control nova_senha_confirmar', 'placeholder' => 'Confirmar Nova Senha']) }}
