...
<div class="tab-pane active">
	{{ Form::open(['method' => 'post', 'url' => url('users/address'), 'class' => 'form-horizontal']) }}
		<div class="form-group {{ $errors->has('cep') ? 'has-error' : '' }}">
			...
			<div class="col-md-9">
				{{ Form::text('cep', $model->cep, ['class' => 'form-control', 'placeholder' => '']) }}
		...
		<div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
			...
			<div class="col-md-9">
				{{ Form::text('address', $model->address, ['class' => 'form-control', 'placeholder' => '']) }}
		...
		<div class="form-group {{ $errors->has('number') ? 'has-error' : '' }}">
			...
			<div class="col-md-9">
				{{ Form::text('number', $model->number, ['class' => 'form-control', 'placeholder' => '']) }}
		...
		<div class="form-group {{ $errors->has('city') ? 'has-error' : '' }}">
			...
			<div class="col-md-9">
				{{ Form::text('city', $model->city, ['class' => 'form-control', 'placeholder' => '']) }}
		...
		<div class="form-group {{ $errors->has('state_id') ? 'has-error' : '' }}">
			...
			<div class="col-md-9">
				{{ Form::select('state_id', $states, $model->state_id, ['class' => 'form-control select2', 'placeholder' => '']) }}
