...
class PermissionsSeeder extends Seeder {
    ...
    public function run() {
        ...
        \DB::table('permissions')->insert([
            ...
            [
				'id' => '52', 
				'permission' => 'UPDRULES_LIST', 
				'desc' => 'Assinaturas de SPAM - Listagem', 
            ],
            [
				'id' => '53', 
				'permission' => 'UPDRULES_ADD', 
				'desc' => 'Assinaturas de SPAM - Adicionar', 
            ],
            [
				'id' => '54', 
				'permission' => 'UPDRULES_EDIT', 
				'desc' => 'Assinaturas de SPAM - Editar', 
            ],
            [
				'id' => '55', 
				'permission' => 'UPDRULES_REM', 
				'desc' => 'Assinaturas de SPAM - Remover', 
            ],
            [
				'id' => '56', 
				'permission' => 'UPDRULES_SHOW', 
				'desc' => 'Assinaturas de SPAM - Visualizar', 
            ],
            [
				'id' => '57', 
				'permission' => 'UPDSDFNDRS_LIST', 
				'desc' => 'Smart Defender - Listagem', 
            ],
            [
				'id' => '58', 
				'permission' => 'UPDSDFNDRS_EDIT', 
				'desc' => 'Smart Defender - Editar', 
            ],
            [
				'id' => '59', 
				'permission' => 'UPDSDFNDRS_ADD', 
				'desc' => 'Smart Defender - Adicionar', 
            ],
            [
				'id' => '60', 
				'permission' => 'UPDSDFNDRS_SHOW', 
				'desc' => 'Smart Defender - Visualizar', 
            ],
            [
				'id' => '61', 
				'permission' => 'UPDSDFNDRS_REM', 
				'desc' => 'Smart Defender - Remover', 
            ],
        ]);
    }
}
